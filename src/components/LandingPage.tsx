          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex items-center gap-3 text-sm text-slate-200">
                ...
                <span>BIR tax calendar (2550Q, 1601-C, LGU renewals)</span>
              </div>
            ...
            <div className="pt-4 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
              <span className="flex items-center gap-1.5">
                ...
                <span>Hashed Passwords & Server-Side Sessions</span>
              </span>
              <span className="flex items-center gap-1.5">
              ...
              {authMode === 'LOGIN' && (
                <form onSubmit={handleLoginSubmit} className="space-y-4 text-left">
                  <div className="mb-2">
                    ...
                    <p className="text-xs text-slate-400 mt-1">Enter your account credentials</p>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-emerald-500 hover:bg-emerald-400 disabled:opacity-60 text-slate-950 font-bold text-sm rounded-xl shadow-lg shadow-emerald-500/20 transition-all flex items-center justify-center gap-2 mt-2"
                  >
                    {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin" /> : <span>Sign In to Firm Portal</span>}
                ...
                <form onSubmit={handleSignupSubmit} className="space-y-3.5 text-left">
                  ...
                  {signupRole === 'System Administrator' && (
                    <div className="bg-emerald-500/10 border border-emerald-500/30 p-3 rounded-xl space-y-1.5">
                      <div className="text-xs font-bold text-emerald-400">Admin Security Passcode</div>
                      <input
                        type="password"
                        value={adminKeyInput}
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full py-2.5 bg-emerald-500 hover:bg-emerald-400 disabled:opacity-60 text-slate-950 font-bold text-sm rounded-xl shadow-lg shadow-emerald-500/20 transition-all flex items-center justify-center gap-2 mt-2"
                  >
